...
import {LucideArrowLeftToLine, LucideArrowRightToLine, LucideMenu} from "lucide-react"
...
function SidebarTrigger({
    ...
    const Icon = state === "collapsed" ? LucideArrowRightToLine : LucideArrowLeftToLine
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-300 ease-in-out focus-visible:ring-2 [&>svg]:shrink-0",
